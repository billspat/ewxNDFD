#
# ewxNDFD documentation build configuration file
#
import os
import sys
...
project = "ewxNDFD"
copyright = "Copyright © 2025 Patrick Bills"
...
# built documents.
try:
    version = importlib.metadata.version("ewxndfd")
